...
export default class FCB1010 extends MidiDevice {
  ...
  async updateDisplay() {
    ...
    let tensPlaceCharacter = this.displayString.charAt(0)
    ...
    let onesPlaceCharacter = this.displayString.charAt(1)
    console.log(onesPlaceCharacter)
    ...
    if(onesPlaceIndex < 0) {
      ...
      onesPlaceIndex = onesPlaceIndex < 0 ? FCB1010.options.ONES_PLACE_DEFAULT : onesPlaceIndex
    }
